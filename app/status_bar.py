...
from ui.dayu_widgets import MLabel, dayu_theme
...
class StatusBar(QStatusBar):
    def __init__(self, parent=None):
        ...
        self.file_changed_label = MLabel("文件状态: 未变更")
        self.file_size_label = MLabel("文件大小: 0 KB")
    ...
    def update_file_status(self, is_changed):
        self.file_changed_label.setText(
            f"文件状态: {'已变更' if is_changed else '未变更'}")
