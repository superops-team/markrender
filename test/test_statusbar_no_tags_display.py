...
class TestWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Statusbar无标签显示测试")
        ...
        # 添加测试说明
        info_label = QLabel("测试Statusbar中无标签时使用tag方式显示'无'")
        ...
        # 添加说明
        note_label = QLabel("观察statusbar中无标签时使用tag样式显示'无'，而不是普通文字")
