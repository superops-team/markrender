...
# -*- coding: utf-8 -*-
"""
测试statusbar中将page_type作为首个tag显示
"""
...
class TestWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Statusbar PageType作为首个Tag测试")
        ...
        # 添加测试说明
        info_label = QLabel("测试Statusbar中将PageType作为首个Tag显示")
        ...
        # 添加说明
        note_label = QLabel("观察statusbar中PageType标签(带颜色)作为首个标签显示的效果")
