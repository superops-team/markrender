...
"""
设计优化测试脚本
验证statusbar、sidebar以及APP底色的优化效果
"""
...
from app.preference.style_constants import NEUTRAL_50, NEUTRAL_200, PRIMARY_500

class DesignOptimizationTestWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("设计优化测试")
        self.resize(800, 600)
...
def main():
    ...
    # 创建测试窗口
    window = DesignOptimizationTestWindow()
    window.show()
