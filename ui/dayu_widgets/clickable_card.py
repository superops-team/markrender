...
class ClickCard(QtWidgets.QWidget):
    ...
    def __init__(
        ...
        if extra:
            ...
            self._extra_button.clicked.connect(
                self._on_extra_button_clicked)  # Handle extra button click
    ...
    def set_widget(self, widget):
        # Make new widget transparent to mouse events
...
class ClickMeta(QtWidgets.QWidget):
    ...
    def setup_data(self, data_dict):
        ...
        if "extra_clicked" in data_dict and callable(
                data_dict["extra_clicked"]):
