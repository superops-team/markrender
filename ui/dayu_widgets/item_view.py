...
def slot_context_menu(self, point):
    ...
    if proxy_index.isValid():
        ...
        event = utils.ItemViewMenuEvent(
            view=self, selection=selection, extra={})
...
class MTableView(QtWidgets.QTableView):
    ...
    def save_state(self, name):
        ...
        settings.setValue("{}/headerState".format(name,
                          self.header_view.saveState()))
