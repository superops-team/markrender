...
class MSectionItem(QtWidgets.QWidget):
    ...
    def __init__(
        ...
        self.selected_value_label.setAlignment(
            QtCore.Qt.AlignRight | QtCore.Qt.AlignVCenter)
        header_lay.insertWidget(
            header_lay.count() - 2,
    ...
    def _set_expand(self, value):
        ...
        self.expand_icon.setPixmap(
            MPixmap("up_line.svg" if value else "down_line.svg").scaledToHeight(12))
...
class MCollapse(QtWidgets.QWidget):
    ...
    def add_section(self, section_data):
        ...
        self._main_layout.insertWidget(
            self._main_layout.count(), section_widget)
        ...
        if isinstance(section_data.get("widget"), MRadioButtonGroup):
            ...
            radio_group.sig_checked_changed.connect(
                lambda index, text: self.update_section_value(
                    section_widget, text))
            ...
            if default_selection is not None:
                ...
                if default_button:
                    self.update_section_value(
                        section_widget, default_button.text())
